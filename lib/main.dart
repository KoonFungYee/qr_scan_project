...
class _MyAppState extends State<MyApp> {
          ...
          children: <Widget>[
            ...
            Container(
                child: Image.file(File(
                    '/data/user/0/com.example.junior/app_flutter/file_01.jpg'))),
            Container(
              child: Row(
                children: <Widget>[
  ...
  Future _scanPhoto() async {
    ...
    // String base64Image = base64Encode(tempStore.readAsBytesSync());
    // print(base64Image);
  ...
  Future _generateBarCode(String inputCode) async {
    ...
    try {
      final dir =
          Directory("/data/user/0/com.example.junior/app_flutter/file_01.jpg");
      dir.deleteSync(recursive: true);
    } catch (err) {}
    var file = File("/data/user/0/com.example.junior/app_flutter/file_01.jpg");
